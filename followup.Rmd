...
COBRE_wtar <- COBRE %>% select(., sub_id, wtar_raw=CNP_05, age=CNP_01) #need to standardize these scores (and maybe compare to predicted scores as in here ->> https://link.springer.com/referenceworkentry/10.1007%2F978-0-387-79948-3_1500) (wtar_standard cnp_06 is all blank :( ))
